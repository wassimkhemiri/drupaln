 ...
 *
 * @Action(
 *   id = "entity:book_action",
 *   action_label = @Translation("Book Opening Instance"),
 *   confirm_form_route_name = "bookable_calendar_vbo_booking.booking_form",
 *   deriver = "Drupal\bookable_calendar_vbo_booking\Plugin\Action\Derivative\EntityBookActionDeriver"
 * )
 */
class BookAction extends EntityActionBase implements ContainerFactoryPluginInterface {
