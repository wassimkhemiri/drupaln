...
/**
 * A handler to provide proper displays for opening instance available slots.
 *
 * @ingroup views_field_handlers
 *
 * @ViewsField("bookable_calendar_available_slots")
 */
class AvailableSlots extends FieldPluginBase {
  ...
  public function getValue(ResultRow $values, $field = NULL) {
    ...
    if ($entity instanceof BookableCalendarOpeningInstance) {
      return $entity->get('available_slots')->getvalue()[0]['value'];
    }
