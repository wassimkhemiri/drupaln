...
Drupal.t("Row");
Drupal.t('Bootstap responsive row');
Drupal.t('Layout');
Drupal.t('Device breakpoint');
...
Drupal.t("Section");
Drupal.t('Bootstrap grid container');
Drupal.t('Layout');
Drupal.t('Full Width');
Drupal.t("Yes");
Drupal.t('100% Height');
...
Drupal.t("Loop");
Drupal.t("Unmute (Not reliable when autoplaying due to recent browser policy updates)");
...
Drupal.t("Tabs");
Drupal.t('Bootstrap content tabs');
Drupal.t('Layout');
...
Drupal.t('Curved Horiztonal Drop Shadow');
...
Drupal.t('slideOutUp')
Drupal.t("Collapsibles");
Drupal.t('Bootstrap Collapsibles');
Drupal.t("Layout");
Drupal.t("Collapsed?");
Drupal.t("Yes");
...
Drupal.t('Alert box');
Drupal.t("Message");
Drupal.t(          "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."        );
Drupal.t("Type");
...
Drupal.t("Danger")
Drupal.t("Blockquote");
Drupal.t('Blockquote box');
Drupal.t("Text");
Drupal.t(          "Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."        );
Drupal.t("Cite");
Drupal.t("Reverse?");
Drupal.t("Yes")
Drupal.t("Title");
...
Drupal.t("Specifiy Time Only (repeating on every day)");
...
Drupal.t("Thousand Seperator");
Drupal.t(          "Select a character to seperate thousands in the end number."        );
Drupal.t("None");
Drupal.t("Comma");
Drupal.t("Dot");
Drupal.t("Space");
...
Drupal.t('Animated progress bar');
Drupal.t("Label");
Drupal.t("Progress");
Drupal.t("Bar height");
Drupal.t("Back Color");
...
Drupal.t("Center");
Drupal.t("Right");
Drupal.t('Horizontal separator')
Drupal.t("Text");
Drupal.t('Text with editor');
Drupal.t("Text");
Drupal.t("Edit text")
...
Drupal.t("Yes")
Drupal.t("Well");
Drupal.t('Content box');
Drupal.t("Type");
Drupal.t("Default");
Drupal.t("Large");
Drupal.t("Small")
Drupal.t("Social links");
Drupal.t('Branded Social Links');
Drupal.t("Social links");
Drupal.t("Layout");
Drupal.t("Inline");
Drupal.t("Stacked");
