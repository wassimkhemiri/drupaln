...
class __TwigTemplate_1424ba159d75f5282e9ef2937517fd66 extends Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap5/templates/content-edit/filter-tips.html.twig", "C:\\xampp\\htdocs\\drupal\\web\\themes\\contrib\\bootstrap5\\templates\\content-edit\\filter-tips.html.twig");
    }
